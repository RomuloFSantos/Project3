...
def main():
    ...
    parser = argparse.ArgumentParser(description='A tool to manipulate a chip-seq sqlite DB')
    ...
    parser_index = subparsers.add_parser('create_db',
    ...
    parser_select = subparsers.add_parser('select',
                                          help='Select fields from the DB')
    ...
    parser_select.add_argument('--cell_type',
                               default=False,
                               action='store_true',
                               help='Select all cell types',
                               required=False)

    parser_select.add_argument('--assay',
                               default=False,
                               action='store',
                               help='Select all tracks from assay',
                               required=False)

    parser_select.add_argument('--act',
                               default=False,
                               action='store',
    ...
    parser_update.add_argument("--assay",
                               default=None,
                               action="store",
                               help="Name of the assay",
                               required=False)

    parser_update.add_argument("--assay_new",
                               default=None,
                               action="store",
                               help="assay_new",
                               required=False)

    parser_update.add_argument("--donor",
                               default=None,
                               action="store",
                               help="Name of the donor",
                               required=False)

    parser_update.add_argument("--donor_new",
                               default=None,
                               action="store",
                               help="Name of the donor",
                               required=False)
    ...
    parser_delete = subparsers.add_parser('delete',
                                          help='delete rows from the db')

    parser_delete.add_argument("--tn",
                               default=None,
                               action="store",
                               help="Delete rows where this track_name appears",
                               required=False)
